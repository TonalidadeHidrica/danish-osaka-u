...
new PlayItem(oqs_IMAGE, 'oqs/vokal02/DSCN0365.jpg',0),
...
new PlayItem(oqs_IMAGE, 'oqs/vokal02/DSCN0365.jpg',0),
new PlayItem(oqs_HTML_MX, '単語が２つ続けて発音されます．発音されている母音が同じ母音であるか，違う母音であるかを答えてください．',0),
new PlayItem(oqs_AUDIO, 'oqs/vokal02/ev05.mp3',)
], [
...
new PlayItem(oqs_AUDIO, 'oqs/vokal02/00q_009.mp3',),
new PlayItem(oqs_VIDEO, 'oqs/vokal02/ev05.mp4',)
], [
...
new PlayItem(oqs_IMAGE, 'oqs/vokal02/IMG_3311.jpg',0),
new PlayItem(oqs_HTML_MX, 'Prøv igen! （もう１回！）',0),
new PlayItem(oqs_AUDIO, 'oqs/vokal02/00q_005.mp3',)
], [
...
new PlayItem(oqs_IMAGE, 'oqs/vokal02/DSCN0365.jpg',0),
new PlayItem(oqs_HTML_MX, '単語が２つ続けて発音されます．発音されている母音が同じ母音であるか，違う母音であるかを答えてください．',0),
new PlayItem(oqs_AUDIO, 'oqs/vokal02/ev06.mp3',)
], [
new UiItem(oqs_BUTTON, '同じ', oqs_STATE, 'correct02', ),
new UiItem(oqs_BUTTON, '違う', oqs_STATE, 'mistake02', ),
...
new PlayItem(oqs_HTML_MX, 'Glimrende! （素晴らしい！）',0),
new PlayItem(oqs_AUDIO, 'oqs/vokal02/00q_009.mp3',),
new PlayItem(oqs_VIDEO, 'oqs/vokal02/ev06.mp4',)
], [
new UiItem(oqs_BUTTON, 'もう1度確認', oqs_STATE, 'play02', ),
...
new PlayItem(oqs_IMAGE, 'oqs/vokal02/DSCN0365.jpg',0),
new PlayItem(oqs_HTML_MX, '単語が２つ続けて発音されます．発音されている母音が同じ母音であるか，違う母音であるかを答えてください．',0),
new PlayItem(oqs_AUDIO, 'oqs/vokal02/ev07.mp3',)
], [
...
new PlayItem(oqs_HTML_MX, 'Glimrende! （素晴らしい！）',0),
new PlayItem(oqs_AUDIO, 'oqs/vokal02/00q_009.mp3',),
new PlayItem(oqs_VIDEO, 'oqs/vokal02/ev07.mp4',)
], [
