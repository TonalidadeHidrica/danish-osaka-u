...
new PlayItem(oqs_IMAGE, 'oqs/vokal01/IMG_3232.jpg',0),
...
new PlayItem(oqs_IMAGE, 'oqs/vokal01/IMG_3232.jpg',0),
new PlayItem(oqs_AUDIO, 'oqs/vokal01/ev15.mp3',)
], [
...
new PlayItem(oqs_AUDIO, 'oqs/vokal01/00q_009.mp3',),
new PlayItem(oqs_VIDEO, 'oqs/vokal01/ev15.mp4',)
], [
new UiItem(oqs_BUTTON, 'もう1度確認', oqs_STATE, 'play01', ),
...
new PlayItem(oqs_IMAGE, 'oqs/vokal01/IMG_4096.jpg',0),
new PlayItem(oqs_HTML_MX, 'Prøv igen! （もう１回！）',0),
new PlayItem(oqs_AUDIO, 'oqs/vokal01/00q_005.mp3',)
], [
...
new PlayItem(oqs_IMAGE, 'oqs/vokal01/IMG_3232.jpg',0),
new PlayItem(oqs_HTML_MX, '単語が２つ続けて発音されます．発音されている母音が同じ母音であるか，違う母音であるかを答えてください．',0),
new PlayItem(oqs_AUDIO, 'oqs/vokal01/ev16.mp3',)
], [
...
new PlayItem(oqs_HTML_MX, 'Glimrende! （素晴らしい！）',0),
new PlayItem(oqs_AUDIO, 'oqs/vokal01/00q_009.mp3',),
new PlayItem(oqs_VIDEO, 'oqs/vokal01/ev16.mp4',)
], [
...
new PlayItem(oqs_IMAGE, 'oqs/vokal01/IMG_3232.jpg',0),
new PlayItem(oqs_HTML_MX, '単語が２つ続けて発音されます．発音されている母音が同じ母音であるか，違う母音であるかを答えてください．',0),
new PlayItem(oqs_AUDIO, 'oqs/vokal01/ev17.mp3',)
], [
new UiItem(oqs_BUTTON, '同じ', oqs_STATE, 'correct03', ),
new UiItem(oqs_BUTTON, '違う', oqs_STATE, 'mistake03', ),
...
new PlayItem(oqs_HTML_MX, 'Glimrende!（素晴らしい！）',0),
new PlayItem(oqs_AUDIO, 'oqs/vokal01/00q_009.mp3',),
new PlayItem(oqs_VIDEO, 'oqs/vokal01/ev17.mp4',)
], [
