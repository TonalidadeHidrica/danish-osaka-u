...
new PlayItem(oqs_IMAGE, 'oqs/vokal04/IMG_3764.jpg',0),
...
new PlayItem(oqs_IMAGE, 'oqs/vokal04/IMG_3764.jpg',0),
new PlayItem(oqs_AUDIO, 'oqs/vokal04/ev11.mp3',)
], [
new UiItem(oqs_BUTTON, '同じ', oqs_STATE, 'correct01', ),
new UiItem(oqs_BUTTON, '違う', oqs_STATE, 'mistake01', ),
...
new PlayItem(oqs_AUDIO, 'oqs/vokal04/00q_009.mp3',),
new PlayItem(oqs_VIDEO, 'oqs/vokal04/ev11.mp4',)
], [
...
new PlayItem(oqs_IMAGE, 'oqs/vokal04/IMG_3532.jpg',0),
new PlayItem(oqs_HTML_MX, 'Prøv igen! （もう１回！）',0),
new PlayItem(oqs_AUDIO, 'oqs/vokal04/00q_005.mp3',)
], [
...
new PlayItem(oqs_IMAGE, 'oqs/vokal04/IMG_3764.jpg',0),
new PlayItem(oqs_HTML_MX, '単語が２つ続けて発音されます．発音されている母音が同じ母音であるか，違う母音であるかを答えてください．',0),
new PlayItem(oqs_AUDIO, 'oqs/vokal04/ev12.mp3',)
], [
...
new PlayItem(oqs_HTML_MX, 'Glimrende! （素晴らしい！）',0),
new PlayItem(oqs_AUDIO, 'oqs/vokal04/00q_009.mp3',),
new PlayItem(oqs_VIDEO, 'oqs/vokal04/ev12.mp4',)
], [
...
new PlayItem(oqs_IMAGE, 'oqs/vokal04/IMG_3764.jpg',0),
new PlayItem(oqs_HTML_MX, '単語が２つ続けて発音されます．発音されている母音が同じ母音であるか，違う母音であるかを答えてください．',0),
new PlayItem(oqs_AUDIO, 'oqs/vokal04/ev13.mp3',)
], [
...
new PlayItem(oqs_HTML_MX, 'Glimrende!（素晴らしい！）',0),
new PlayItem(oqs_AUDIO, 'oqs/vokal04/00q_009.mp3',),
new PlayItem(oqs_VIDEO, 'oqs/vokal04/ev13.mp4',)
], [
...
new PlayItem(oqs_IMAGE, 'oqs/vokal04/IMG_3764.jpg',0),
new PlayItem(oqs_HTML_MX, '単語が２つ続けて発音されます．発音されている母音が同じ母音であるか，違う母音であるかを答えてください．',0),
new PlayItem(oqs_AUDIO, 'oqs/vokal04/ev14.mp3',)
], [
new UiItem(oqs_BUTTON, '同じ', oqs_STATE, 'mistake04', ),
new UiItem(oqs_BUTTON, '違う', oqs_STATE, 'correct04', ),
...
new PlayItem(oqs_HTML_MX, 'Glimrende! （素晴らしい！）',0),
new PlayItem(oqs_AUDIO, 'oqs/vokal04/00q_009.mp3',),
new PlayItem(oqs_VIDEO, 'oqs/vokal04/ev14.mp4',)
], [
